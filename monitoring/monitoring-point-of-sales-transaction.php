                        ...
                        {   
                            ...
                            <tr>
                                ...
                                <td data-label="Customer Name"> <?php if($rows['customer_name']){
                                 ...
                                 ?></td>
                                <td data-label="Order Details"> <a class="viewTransaction" href="../monitoring/monitoring-point-of-sales-transaction-viewdetails.php?view=<?php echo $rows['uuid'];?>">View Details</a></td>
