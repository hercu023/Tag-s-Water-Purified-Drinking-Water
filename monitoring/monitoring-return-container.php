...
if (!get_user_access_per_module($con, $_SESSION['user_user_type'], 'MONITORING-RETURN_CONTAINER')) {
...
<head>
   ...
   <div class="side-bar">
        ...
        MONITORING<i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                <a href="monitoring-delivery-pickup.php" class="sub-item" id="monitoring-deliverypickup">Delivery/Pick Up</a>
                <a href="monitoring-return-container.php" class="sub-item" id="monitoring-returncontainer">Return Container</a>
                <a href="monitoring-customer-balance.php" class="sub-item" id="monitoring-customerbalance">Customer Balance</a>
                <a href="monitoring-scheduling.php" class="sub-item" id="monitoring-scheduling">Scheduling</a>
                <a href="monitoring-item-history.php" class="sub-item" id="monitoring-itemhistory">Item History</a>
            </div>
        </div>
        ...
        SETTINGS<i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                ...
                <a href="../settings/Settings-datalogs.php" class="sub-item" id="settings-datalogs">Data Logs</a>
                <a href="../settings/settings-data-archive-customers.php" class="sub-item" id="settings-dataarchive">Archive</a>
                <a href="../settings/Settings-databackup-customers.php" class="sub-item" id="settings-databackup">Backup/Restore</a>
            </div>
        </div>
    </div>
   </div>
            ...
            <div class="main-dashboard">
                ...
                <div class="top-menu">  
                    <div class="menu-bar">
                        ...
                        <h2 class="dashTitle-top">MONITORING</h2>
                        <div class="user1">
                            <div class="welcome">
                                <h4 > Welcome, </h4>
                            </div>
