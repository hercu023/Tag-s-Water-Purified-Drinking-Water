...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <link rel="stylesheet" type="text/css" href="../CSS/monitoring-item-history.css">
    ...
    <body>
        ...
        ?>
            ...
            <?php  
                ...
                $total_records = $row[0];     
                $page_location = '../monitoring/monitoring-item-history.php';
            ...
            <main>
                ...
                <tr>
                    ...
                    <td data-label="Details"> <?php echo $rows['details']; ?></td>
                    <td data-label="Action"> <?php echo $rows['action']; ?></td>
            ...
            <div class="top-menu">
                <div class="menu-bar">
                    ...
                    <h4 class="subTitle-top">Item History</h2>
                    <div class="user1">
                        <div class="welcome">
                            <h4 > Welcome, </h4>
                        </div>
