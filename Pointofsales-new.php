        ...
        <!-- <div class="form-container"> -->
            <div class="form1">
                ...
                <div class="form1-ordertype-buttons">
                    <a href="Pointofsales.php" class="refillOrder-button">Refill</a>
                    <a href="Pointofsales-new.php" class="newOrder-button">New</a>
                </div>
                ...
                <div class="form1-details">
                    <div class="form1-tableoption-buttons">
                        <img class="containerlogo" src="../Tag-s-Water-Purified-Drinking-Water/Pictures and Icons/gallon.png">    
                        <button class="containerTable-button">Container</button>
                        <br>
                        <img class="bottlelogo" src="../Tag-s-Water-Purified-Drinking-Water/Pictures and Icons/plastic-bottle.png">    
                        <button class="bottleTable-button">Bottle</button>
                        <br>
                        <img class="menulogo" src="../Tag-s-Water-Purified-Drinking-Water/Pictures and Icons/menu.png">    
                            ...
                            <div class="totalOrder">
                                ...
                                <body>
                                    ...
                                    <div class="receipt-buttons">
                                        <a href="Pointofsales-new.php" id="cancel">CANCEL</a>   
