...
<div class="container">
    ...
    <?php  
                ...
                if(isset($_GET['option']) && $_GET['option'] == "Daily") {
                    ...
                    $page_location = '../reports/reports-expense.php?option=Daily';
                    ...
                    $rs_result = mysqli_query($con, $query);     
                    $row = mysqli_fetch_row($rs_result);     
                    $page_location = '../reports/reports-expense.php?option=Monthly';
                    $total_records = mysqli_num_rows($rs_result); 
                    ...
                    $rs_result = mysqli_query($con, $query);     
                    $row = mysqli_fetch_row($rs_result);     
                    $page_location = '../reports/reports-expense.php?option=Yearly';
                    $total_records = mysqli_num_rows($rs_result); 
                } else {
                    $total_records = 0;     
                }
                ...
                if (isset($_GET['from']) && isset($_GET['to'])) {
                    ...
                    $query = "SELECT 
                        ...
                        $rs_result = mysqli_query($con, $query);     
                        $row = mysqli_fetch_row($rs_result);     
                        $page_location = '../reports/reports-expense.php?option=Daily&from='.$from.'&to='.$to;
                        $total_records = mysqli_num_rows($rs_result);      
                    } 
    ...
    <div class="top-menu">
                <div class="menu-bar">
                    ...
                    <h4 class="subTitle-top">EXPENSES</h2>
                    <div class="user1">
                        <div class="welcome">
                            <h4 > Welcome, </h4>
                        </div>
