...
<div class="container">
    ...
    <?php  
                ...
                if(isset($_GET['option']) && $_GET['option'] == "Daily") {
                    ...
                    $page_location = '../reports/reports-delivery.php?option=Daily';
                    ...
                    $rs_result = mysqli_query($con, $query);     
                    $row = mysqli_fetch_row($rs_result);     
                    $page_location = '../reports/reports-delivery.php?option=Monthly';
                    $total_records = mysqli_num_rows($rs_result); 
                    ...
                    $rs_result = mysqli_query($con, $query);     
                    $row = mysqli_fetch_row($rs_result);     
                    $page_location = '../reports/reports-delivery.php?option=Yearly';
                    $total_records = mysqli_num_rows($rs_result); 
                } else {
                    $total_records = 0;     
                }
                ...
                if (isset($_GET['from']) && isset($_GET['to'])) {
                    ...
                    $query = "SELECT 
                        ...
                        $rs_result = mysqli_query($con, $query);     
                        $row = mysqli_fetch_row($rs_result);     
                        $page_location = '../reports/reports-delivery.php?option=Daily&from='.$from.'&to='.$to;
                        $total_records = mysqli_num_rows($rs_result);      
                    } 
...
<script src="../javascript/reports-delivery-search.js"></script>
