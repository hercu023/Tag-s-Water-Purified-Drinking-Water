   ...
   <div class="side-bar">
        ...
        REPORTS<i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                ...
                <a href="reports-delivery-walkin.php" class="sub-item" id="reports-deliverywalkin">Delivery/Walk-in</a>
                ...
                <a href="reports-item-issue.php" class="sub-item" id="reports-itemissue">Item Issue</a>
