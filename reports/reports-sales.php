                    ...
                    <table class="table" id="myTable">
                        ...
                        if(isset($_GET['option']) && $_GET['option'] == "Daily") {
                            ...
                            $query = "SELECT
                                ...
                                MONTHNAME(transaction.created_at_date) AS month,
                                SUM(transaction.total_amount) as total
                                FROM transaction 
                                WHERE transaction.status_id = 1
                                GROUP BY MONTH(transaction.created_at_date),
                        ...
                        <?php } else {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(isset($_GET['option']) && $_GET['option'] == "Daily") { ?>
                                            <a href="../reports/reports-sales-view-details.php?view=<?php echo $rows['date']; ?>">
                                                View Details 
                                            </a>
                                    <?php } else if (isset($_GET['option']) && $_GET['option'] == "Monthly") { ?>
                                            <a href="../reports/reports-sales-view-details.php?month=<?php echo $rows['month'].'&year='.$rows['year']; ?>">
                                                View Details 
                                            </a>
                                    <?php } else { ?>
                                            <a href="../reports/reports-sales-view-details.php?year=<?php echo $rows['year'];?>">
                                                View Details 
                                            </a>
                                    <?php } ?>
                                </td>
                                <td>
                                    <?php if(isset($_GET['option']) && $_GET['option'] == "Daily") { ?>
                                        <?php echo 'Sales Report Details For Date: '.$rows['date']; ?>
                                    <?php } else if (isset($_GET['option']) && $_GET['option'] == "Monthly") { ?>
                                        <?php echo 'Sales Report Details For The Month: '.$rows['month'].' '.$rows['year']; ?>
                                    <?php } else { ?>
                                        <?php echo 'Sales Report Details For Year: '.$rows['year']; ?>
                                    <?php } ?>
                                </td>
                                <td>
