...
<?php  
                        ...
                        <div class="sub-tab-container">
                            ...
                            <?php
                                ...
                                if(isset($_GET['view']) && !isset($_GET['month']) && !isset($_GET['year'])) {
                                    ...
                                    $transaction = mysqli_fetch_assoc($transaction_count_result);
                                    ?>
                                    <h3 class="deliveries">Transactions</h3>
                                    <span class="total-deliveries"><?php echo $transaction['total'];?></span>
                                </div>
                            </div>
                            <div class="newUser-button2"> 
                                ...
                                if(isset($_GET['view']) && !isset($_GET['month']) && !isset($_GET['year'])) {
                                    ...
                                    $walkin = mysqli_fetch_assoc($walkin_count_result);
                                    ?>
                                    <h3 class="deliveries">Walk In</h3>
                                    <span class="total-deliveries"><?php echo $walkin['total'];?></span>
                                </div>
                            </div>  
                            <div class="newUser-button3"> 
                                ...
                                if(isset($_GET['view']) && !isset($_GET['month']) && !isset($_GET['year'])) {
                                    ...
                                    $delivery = mysqli_fetch_assoc($delivery_count_result);
                                    ?>
                                    <h3 class="deliveries">Delivery</h3>
                                    <span class="total-deliveries"><?php echo $delivery['total'];?></span>
                                </div>
                            </div>  
                            <div class="newUser-button4"> 
                                ...
                                if(isset($_GET['view']) && !isset($_GET['month']) && !isset($_GET['year'])) {
                                    ...
                                    $sales = mysqli_fetch_assoc($total_sales_result);
                                    ?>
                                    <h3 class="deliveries">Total Sales</h3>
                                    <span class="total-deliveries"><?php echo '&#8369 '.number_format($sales['total'], '2','.',',');?></span>
                                </div>
                            </div>  
                            <div class="bot-buttons">
                                <div class="AddButton1">
                                    <button type="button" onclick="print();" id="addcustomerBtn">
    ...
    <div class="top-menu">
                <div class="menu-bar">
                    ...
                    <h4 class="subTitle-top">SALES REPORT</h2>
                    <div class="user1">
                        <div class="welcome">
                            <h4 > Welcome, </h4>
                        </div>
