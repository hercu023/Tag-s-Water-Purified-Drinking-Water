...
<div class="container">
    ...
    <?php  
                ...
                if(isset($_GET['option']) && $_GET['option'] == "Daily") {
                    ...
                    $page_location = '../reports/reports-item-issue.php?option=Daily';
                    ...
                    $rs_result = mysqli_query($con, $query);     
                    $row = mysqli_fetch_row($rs_result);     
                    $page_location = '../reports/reports-item-issue.php?option=Monthly';
                    $total_records = mysqli_num_rows($rs_result); 
                    ...
                    $rs_result = mysqli_query($con, $query);     
                    $row = mysqli_fetch_row($rs_result);     
                    $page_location = '../reports/reports-item-issue.php?option=Yearly';
                    $total_records = mysqli_num_rows($rs_result); 
                } else {
                    $total_records = 0;     
                }
                ...
                if (isset($_GET['from']) && isset($_GET['to'])) {
                    ...
                    ORDER BY DATE(inventory_log.created_at) DESC";
                        $rs_result = mysqli_query($con, $query);     
                        $row = mysqli_fetch_row($rs_result);     
                        $page_location = '../reports/reports-item-issue.php?option=Daily&from='.$from.'&to='.$to;
                        $total_records = mysqli_num_rows($rs_result);      
                    } 
                    ...
                    <div class="sub-tab-container">
                        <form action="" method="post">
                            <div class="select-dropdown">
                                <select class="select" name="option" onchange="location = '../reports/reports-item-issue.php?option=' + this.value;">
                            ...
                            <div class="newUser-button">
                                <div class="button1">
                                    <input type="hidden" name="module" value="item-issue">
                    ...
                    <table class="table" id="myTable">
                        ...
                        <?php } else {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(isset($_GET['option']) && $_GET['option'] == "Daily") { ?>
                                            <a href="../reports/reports-item-issue-view-details.php?view=<?php echo $rows['date']; ?>">
                                                View Details 
                                            </a>
                                    <?php } else if (isset($_GET['option']) && $_GET['option'] == "Monthly") { ?>
                                            <a href="../reports/reports-item-issue-view-details.php?month=<?php echo $rows['month'].'&year='.$rows['year']; ?>">
                                                View Details 
                                            </a>
                                    <?php } else { ?>
                                            <a href="../reports/reports-item-issue-view-details.php?year=<?php echo $rows['year'];?>">
                                                View Details 
                                            </a>
                                    <?php } ?>
                                </td>
                                <td>
                                    <?php if(isset($_GET['option']) && $_GET['option'] == "Daily") { ?>
                                        <?php echo 'Item Issue Report Details For Date: '.$rows['date']; ?>
                                    <?php } else if (isset($_GET['option']) && $_GET['option'] == "Monthly") { ?>
                                        <?php echo 'Item Issue Report Details For The Month: '.$rows['month'].' '.$rows['year']; ?>
                                    <?php } else { ?>
                                        <?php echo 'Item Issue Report Details For Year: '.$rows['year']; ?>
                                    <?php } ?>
                                </td>
                                <td>
                                    <?php echo $rows['total']; ?>
