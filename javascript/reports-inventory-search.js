function tableSearch(){
    var input, filter, table, tr, i, Details, Description, TotalPurchasedAmount;             
    ...
    for(i = 0; i < tr.length; i++){
        ...
        TotalPurchasedAmount = tr[i].getElementsByTagName("td")[3];
        


        if(Details || Description || TotalPurchasedAmount){
            ...
            var TotalPurchasedAmount_value = TotalPurchasedAmount.textContent || TotalPurchasedAmount.innerText;
        
        

            if(Details_value.toUpperCase().indexOf(filter) > -1 ||
                Description_value.toUpperCase().indexOf(filter) > -1 ||
                TotalPurchasedAmount_value.toUpperCase().indexOf(filter) > -1) {
