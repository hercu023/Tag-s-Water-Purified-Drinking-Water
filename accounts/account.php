                ...
                <table class="table" id="myTable">
                    ...
                    if(mysqli_num_rows($result) > 0)
                        ...
                        <tr>
                            ...
                            <td data-label="Name"> <?php echo $rows['first_name'].' '.$rows['middle_name'].' '.$rows['last_name']; ?></td>
                            ...
                            <td data-label="Picture"> <img src="<?php echo "../uploaded_image/".$rows['profile_image']; ?>" width="50px"></td>
                            <td class="hrefa">
