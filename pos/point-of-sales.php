    ...
    <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
        ...
        <div class="bg-selectcustomerform" id="bg-selectform">
            <div class="container2">
                ...
                <button class="guest-button" value="Guest">Guest</button>
                <div class="search">
                ...
                <form action="#">
                    <div class="customer-container">
                        <table class="table" id="customerTable">
                            ...
                            <tbody>
                            <tr>
                                <td> <button type="button" class="selectCus"><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20"><path d="m8.229 14.062-3.521-3.541L5.75 9.479l2.479 2.459 6.021-6L15.292 7Z"/></svg></button> </td>
...
// --------------------------------------------------------ADD ORDER TABLE
         <?php
                        $dropdown_query1 = "SELECT * FROM inventory_item WHERE inventory_item.pos_item = 'Yes'";
                        $result3 = mysqli_query($con, $dropdown_query1);
                    ?>
    ...
    $("#selectOrder").click(function(){
        ...
        addcontrols+="<td><select class='selectTable-item'><?php while($row3 = mysqli_fetch_array($result3)):;?><option><?php echo $row3[1];?></option><?php endwhile;?></select></td>"
        addcontrols+="<td><input type='number' class='textBox-table' min='0' placeholder='0' onkeypress='return isNumberKey(event)'></td>"
        addcontrols+="<td><input type='number' class='textBox-table' min='0' placeholder='0' onkeypress='return isNumberKey(event)'></td>"
        addcontrols+="<td><p class='php'>PHP</p><input type='text' class='textBox-table' min='0' placeholder='0.00' onkeypress='return isNumberKey(event)' readonly></td>"
        addcontrols+="<td><p class='php'>PHP</p><input type='text' class='textBox-table' min='0' placeholder='0.00' onkeypress='return isNumberKey(event)' readonly></td>"
        addcontrols+="</tr>";
