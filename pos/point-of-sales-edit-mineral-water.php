                        ...
                        <form action="../service/add-transaction-order.php" method="post" enctype="multipart/form-data" id="addcustomerFrm">
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                <input type='number'id='qty3' class='qty3' min='0' placeholder='0' name="qty3" onkeypress='return isNumberKey(event)'>
                                            </td>
                ...
                <div class="container1">
                    ...
                    <form action="#">
                        ...
                        <div class="profile-pic">
                            ...
                            <input type="text" class="label-item2"  name="mineral-label" value="Mineral">
