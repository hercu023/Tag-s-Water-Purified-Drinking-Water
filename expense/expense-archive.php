...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/expense-archive.css">
        ...
        <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
            <div class="bg-addcustomerform" id="bg-addform">
                ...
                <div class="container1">
                    <h1 class="addnew-title">ARCHIVE EXPENSE</h1>
                    <form action="#">
                        <input type="hidden" required="required" name="id" value="<?=$expense['id'];?>">

                        <div class="a-header">
                            <label class="archive-header"> Do you want to Archive expense with id <?=$expense['id'];?>?</label>
                        </div>
                        <div class="bot-buttons">
                            ...
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="archive-expense">ARCHIVE</button>
                            </div>
                        </div>
                </div>
        </form>
