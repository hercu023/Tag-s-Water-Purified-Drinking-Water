...
<head>
   ...
   <div class="side-bar">
        ...
        REPORTS<i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                <a href="../reports/Reports-sales.php" class="sub-item">Sales</a>
                <a href="../reports/Reports-deliverywalkin.php" class="sub-item">Delivery/Walk-in</a>
        ...
        EMPLOYEE<i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                ...
                <a href="../employee/Employee-details.php" class="sub-item" id="employee-details">Employee List</a>
        ...
        SETTINGS<i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                ...
                <a href="../settings/Settings-dataarchive-customers.php" class="sub-item" id="settings-dataarchive">Archive</a>
            ...
            <div class="main-dashboard">
                ...
                <div class="top-menu">  
                    <div class="menu-bar">
                        ...
                        <h2 class="dashTitle-top">EXPENSE</h2>
                        <div class="user1">
                            <div class="welcome">
                                <h4 > Welcome, </h4>
                            </div>
