...
<head>
   ...
   <div class="side-bar">
    ...
    <div class="backup-topmenu">
        ...
        <select id="s1" class="backup-dropdown" onChange="SelectRedirect();">
            <option href="Settings-databackup-customer.php" id="backup-customers">Customer</option>
            <option href="Settings-databackup-inventory.php" id="backup-inventory" selected="">Inventory</option>
            <option href="Settings-databackup-employees.php" id="backup-employees">Employees</option>
            <option href="Settings-databackup-account.php" id="backup-account">Account</option>
        </select>
        <script>
                function SelectRedirect(){
                    switch(document.getElementById('s1').value){
                        case "Customers":
                            window.location="Settings-databackup-customers.php";
                            break;

                        case "Inventory":
                            window.location="Settings-databackup-inventory.php";
                            break;

                        case "Employees":
                            window.location="Settings-databackup-employees.php";
                            break;

                        case "Account":
                            window.location="Settings-databackup-account.php";
                            break;
    ...
    <div class="backup-location-div">
        <p class="backup-currentLocation">Current Location: </p>
    </div>
