                            ...
                            if(mysqli_num_rows($inventory_run) > 0)
                            {
                                foreach($inventory_run as $rows)
                                {
                                    ...
                                    <tr >
                                        ...
                                        <td data-label="POS"> <?php echo $rows['pos_type']; ?></td>
                                        <td data-label="Reorder Level"> <?php echo $rows['reorder_level']; ?></td>
                                        <td data-label="SRP"> <?php echo $rows['selling_price_item']; ?></td>
                                        <td data-label="Alkaline Price"> <?php echo $rows['alkaline_price']; ?></td>
                                        <td data-label="Mineral Price"> <?php echo $rows['mineral_price']; ?></td>
