...
<div class="container">
    ...
    <main>
        <div class="main-dashboard">
          ...
          if(isset($_GET['edit']))
          {
            ...
            {
              foreach($inventory_run as $inventory_item)
              {
                  ?>
                            <tbody>
                            <tr >
                                    <td class="select-check"><input type="checkbox" name="select-check[]" id="<?php echo $rows['id']; ?>" ></td>
                                    ...
                                    <td>
                                        <a href="../settings/settings-restore-inventory.php?edit=<?php echo $rows['id']; ?>" id="archive-action" class="action-btn" name="action">
    ...
    ?>
         <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
            ...
            <div class="a-header">
                <label class="archive-header"> Are you sure to Restore this row?</label>
            </div>
                    <div class="bot-buttons">
                        <div class="CancelButton">
                            <a href="../settings/Settings-dataarchive-inventory.php" id="cancel">CANCEL</a>
                        </div>
                        <div class="AddButton">
                            <button type="submit" id="addcustomerBtn" name="restore-inventory-checkall">RESTORE</button>
                        </div>
                    </div>
                </div>
            </form>
