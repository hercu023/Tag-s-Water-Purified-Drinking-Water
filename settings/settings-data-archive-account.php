                            ...
                            if(mysqli_num_rows($account_run) > 0)
                            {
                                foreach($account_run as $rows)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="ID"> <?php echo $rows['user_id']; ?></td>
                                        <td data-label="Last Name"> <?php echo $rows['last_name']; ?></td>
                                        <td data-label="First Name"> <?php echo $rows['first_name']; ?></td>
                                        <td data-label="Middle Name"> <?php echo $rows['middle_name']; ?></td>
                                        <td data-label="Email"> <?php echo $rows['email']; ?></td>
                                        <td data-label="Contact Number"> <?php echo $rows['contact_number']; ?></td>
                                        <td data-label="Role"> <?php echo $rows['user_type']; ?></td>
                                        <td data-label="Picture"> <img src="<?php echo "../uploaded_image/".$rows['profile_image']; ?>" width="40px"></td>
