        ...
        <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
            <div class="bg-addcustomerform" id="bg-addform">
                ...
                <div class="container1">
                    <h1 class="addnew-title">RESTORE EMPLOYEE</h1>
                    <form action="#">
                        <input type="hidden" required="required" name="id" value="<?=$employee_id;?>">

                        <div class="a-header">
                            <label class="archive-header"> Are you sure to Restore employee with id: <?=$employee_id;?> ?</label>
                        </div>
                        <div class="bot-buttons">
                            <div class="CancelButton">
                                <a href="../settings/settings-data-archive-employees.php" id="cancel">CANCEL</a>
                            </div>
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="restore-employee">RESTORE</button>
                            </div>
                        </div>
                </div>
        </form>
