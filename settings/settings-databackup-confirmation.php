...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/settings-databackup-confirmation.css">
        ...
        <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
            <div class="bg-addcustomerform" id="bg-addform">
                ...
                <div class="container1">
                    <h1 class="addnew-title">BACK UP DATABASE</h1>
                    <form action="#">
                        <input type="hidden" required="required" name="id" value="<?=$id;?>">
                        <div class="a-header">
                            <label class="archive-header"> Are you sure to back up the system's database?</label>
                        </div>
                        <div class="line"></div>
                        ...
                        <div class="bot-buttons">
                            ...
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="backup-db">CONFIRM</button>
                            </div>
