...
<form action="" method="post" enctype="multipart/form-data" id="adduserFrm">
    <div class="bg-adduserform" id="bg-addform">
        ...
        <div class="container1">
            <h1 class="addnew-title">Confirmation</h1>
                <input type="hidden" required="required" name="id" value="<?=$id?>">
                <div class="main-user-info">
                <div class="a-header">
                    <label class="archive-header"> Are you sure to remove delivery fee?</label>
                </div>
                    <div class="bot-buttons">
                        ...
                        <div class="AddButton">
                            <button type="submit" id="adduserBtn" name="remove-delivery-settings">CONFIRM</button>
                        </div>
                    </div>
            </form>
        </div>
