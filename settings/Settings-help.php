...
<head>
   ...
   <div class="side-bar">
    ...
    <div class="help-container">
        ...
        <div id="question1" class="question1" style="margin: 2rem;"><a class="sub-btn" style="font-size: 1.5rem;">
        HOW TO RESTORE ARCHIVED ITEMS <i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
        ...
        <div id="question2" class="question2" style="margin: 2rem;"><a class="sub-btn" style="font-size: 1.5rem;">
        HOW TO BACKUP ITEMS TO YOUR LOCAL DRIVE <i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                <p class="sub-item" style="margin-left: 1rem;">
