        ...
        <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
            <div class="bg-addcustomerform" id="bg-addform">
                ...
                <div class="container1">
                    <h1 class="addnew-title">RESTORE EXPENSE</h1>
                    <form action="#">
                        <input type="hidden" required="required" name="id" value="<?=$id;?>">
                        <div class="a-header">
                            <label class="archive-header"> Are you sure to Restore Expense with item id: <?=$id;?> ?</label>
                        </div>
                        <div class="bot-buttons">
                            <div class="CancelButton">
                                <a href="../settings/settings-data-archive-expense.php" id="cancel">CANCEL</a>
                            </div>
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="restore-expense">RESTORE</button>
                            </div>
                        </div>
                    </form>
                </div>
