   ...
   <div class="side-bar">
    ...
    <div class="backup-topmenu">
        ...
        <select id="s1" class="backup-dropdown" onChange="SelectRedirect();">
            ...
            <option href="Settings-databackup-inventory.php" id="backup-inventory">Inventory</option>
            <option href="Settings-databackup-employees.php" id="backup-employees" selected="">Employees</option>
