...
<div class="container">
                ...
                <table class="table" id="myTable">
                    ...
                    while ($rows = mysqli_fetch_assoc($result)) {?>
                        ...
                        <tr>
                            ...
                            <td data-label="Name"> <?php echo $rows['first_name'] .' '. $rows['last_name']; ?></td>
                            <td data-label="Email"> <?php echo $rows['email']; ?></td>
                            <td data-label="Module"> <?php echo $rows['name']; ?></td>
                            <td data-label="Status"> <?php if ($rows['status'] == 1) {
                                    echo 'Success';
                                } else {
                                    echo 'Failed';
                                } ?>
                            </td>
                            <td data-label="Data"> <?php echo $rows['data']; ?></td>
                            <td data-label="Date/Time Logged"> <?php echo $rows['date_log']; ?></td>
                        </tr>
    ...
    <div class="top-menu">
                <div class="menu-bar">
                    ...
                    <h4 class="subTitle-top">DATA LOGS</h2>
                    <div class="user1">
                        <div class="welcome">
                            <h4 > Welcome, </h4>
                        </div>
