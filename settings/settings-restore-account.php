    ...
    ?>
         ...
         <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
                <div class="bg-addcustomerform" id="bg-addform">
                    ...
                    <form action="#">
                    <input type="hidden" required="required" name="id" value="<?=$user['user_id'];?>">
                ...
                <label class="archive-header"> Are you sure to Restore this row?</label>
                    ...
                    <div class="bot-buttons">
                        <div class="CancelButton">
                            <a href="../settings/Settings-dataarchive-customers.php" id="cancel">CANCEL</a>
                        </div>
                        <div class="AddButton">
                            <button type="submit" id="addcustomerBtn" name="restore-account">RESTORE</button>
                        </div>
                    </div>
                </div>
            </form>
