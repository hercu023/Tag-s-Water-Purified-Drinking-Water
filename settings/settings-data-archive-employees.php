...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/settings-dataarchive.css">
...
<div class="container">
                ...
                <div class="sub-tab2">
                    <div class="delivery-options">
                        <select class="select" onchange="window.location.href=this.value;">
                            ...
                            <option value="../settings/settings-data-archive-employees.php" selected>Employee</option>
                    ...
                    <form action="../service/restore-settings.php" method="post" id="frm">
                        <table class="table" id="myTable">
                            ...
                            $query = "SELECT 
                                ...
                                WHERE employee.status_archive_id = 2";
                            $customer_run = mysqli_query($con, $query);
                            ...
                            if(mysqli_num_rows($customer_run) > 0)
                            {
                                foreach($customer_run as $rows)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../settings/settings-confirm-restore-employee.php?edit=<?php echo $rows['id']; ?>" id="archive-action" class="action-btn" name="action">
    ...
    <div class="bg-addcustomerform" id="bg-addform">
        <div class="container1">
            <h1 class="addnew-title">RESTORE EMPLOYEES</h1>
            <div class="a-header">
            ...
            <div class="bot-buttons">
                ...
                <div class="AddButton">
                    <button type="submit" id="addcustomerBtn" name="submit-checkall-employees[]">RESTORE</button>
                </div>
            </div>
        </div>
        </form>
