            ...
            <div class="bg-addcustomerform" id="bg-addform">
                ...
                <div class="container1">
                    ...
                    <form action="#">
                        ...
                        <div class="a-header">
                            <label class="archive-header"> Are you sure to Restore attendance with user id: <?=$id;?> ?</label>
                        </div>
                        <div class="bot-buttons">
                            ...
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="restore-attendance">RESTORE</button>
                            </div>
                        </div>
                    </form>
                </div>
