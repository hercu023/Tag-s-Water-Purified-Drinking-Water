<?php
require_once '../service/edit-customer.php';
            ...
            <div class="account-container">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td data-label="Contact Number 2"> </td>
                        <td data-label="Contact Number 1"> </td>
...
<form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
    <div class="bg-addcustomerform" id="bg-addform">
        ...
        <div class="container1">
            ...
            <input type="hidden" required="required" name="customer_id" value="<?=$customer['id'];?>">
            <form action="#">
                <div class="main-user-info">
                    <div class="user-input-box">
                        ...
                        <input type="text"
                               ...
                               name="customer_name"
                               required="required"
                               placeholder="Enter Customer Name"value="<?=$customer['customer_name'];?>">
                    </div>
                    <div class="user-input-box" id="address-box">
                        ...
                        <input type="text"
                               id="address"
                               class="address"
                               required="required" name="address" placeholder="Enter Address" value="<?=$customer['address'];?>">
                    </div>
                    <div class="user-input-box" >
                        <label for="contact_num1">Contact Number 1</label>
                        <input type="text" id="contact_num1" class="contactnum1" onkeypress="return isNumberKey(event)" required="required" name="contact_num1" placeholder="Enter Contact Number" value="<?=$customer['contact_number1'];?>">
                    </div>

                    <div class="user-input-box">
                        <label for="contact_num2">Contact Number 2</label>
                        <input type="text" id="contact_num2"class="contactnum2" onkeypress="return isNumberKey(event)"name="contact_num2" placeholder="Enter Contact Number"value="<?=$customer['contact_number2'];?>">
                    </div>
                    ...
                    <div class="bot-buttons">
                        ...
                        <div class="AddButton">
                            <button type="submit" id="addcustomerBtn" name="edit-customer">SAVE</button>
                        </div>
                    </div>
                </div>
            </form>
            <?php }}else{
           echo '<script> location.replace("../customers/customer.php"); </script>';
    } ?>
</body>
