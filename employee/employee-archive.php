<?php
require_once '../service/archive-employee.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="addcustomerFrm">
            <div class="bg-addcustomerform" id="bg-addform">
                ...
                <div class="container1">
                    <h1 class="addnew-title">ARCHIVE EMPLOYEE</h1>
                    <form action="#">
                        <input type="hidden" required="required" name="id" value="<?=$employee['id'];?>">

                        <div class="a-header">
                            <label class="archive-header"> Do you want to Archive Employee <?=$employee['first_name'].' '.$employee['last_name'];?>?</label>
                        </div>
                        <div class="bot-buttons">
                            ...
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="archive-employee">ARCHIVE</button>
                            </div>
                        </div>
                </div>
        </form>
