...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/employee-attendance-payroll.css">
            ...
            <div class="bg-addcustomerform" id="bg-addform">
                ...
                <div class="container1">
                    ...
                    <form action="#">
                        ...
                        <div class="a-header">
                            <label class="archive-header"> Do you want to Process Payroll for Attendance with id: <?=$attendance['id'];?> ?</label>
                        </div>
                        <div class="bot-buttons">
                            ...
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="payroll-attendance">PROCESS</button>
                            </div>
                        </div>
                </div>
        </form>
