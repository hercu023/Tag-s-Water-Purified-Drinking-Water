        ...
        <div class="menu">
            ...
            <div id="reports" class="item">
                ...
                <div class="sub-menu">
                    ...
                    <a href="../reports/reports-delivery-walkin.php" class="sub-item">Delivery/Walk-in</a>
                    <a href="../reports/reports-datalogs.php" class="sub-item">Data Logs</a>
                    <a href="../reports/reports-inventory.php" class="sub-item">Inventory</a>
                    <a href="../reports/reports-item-issue.php" class="sub-item">Item Issue</a>
                    <a href="../reports/reports-inventory.php" class="sub-item">Attendance</a>
                    <a href="../reports/reports-expense.php" class="sub-item">Expense</a>
                </div>
            </div>
