                        ...
                        <div class="main-user-info">
                            ...
                            <div class="user-input-box">
                                ...
                                <input type="number" min='0' onchange='setTwoNumberDecimal' step="0.25"
                                       ...
                                       name="alkaline_price"
                                       placeholder="0.00"
                                       required="required" value="<?=$inventory_item['alkaline_refill_price'];?>"/>
                            </div>
                            <div class="user-input-box">
                                ...
                                <input type="number" min='0' onchange='setTwoNumberDecimal' step="0.25"
                                       ...
                                       name="mineral_price"
                                       placeholder="0.00"
                                       required="required" value="<?=$inventory_item['mineral_refill_price'];?>"/>
                            </div>
                            <div class="line"></div>
                            ...
                            <div class="gender-category" >
                                <input <?php if($inventory_item['pos_item'] === 'Yes') echo "checked"; ?>
                                        type="radio" value="<?=$inventory_item['pos_item'];?>" name="pos_item" id="Yes" required="required">
                                <label for="Yes" >Yes</label>
                                <input <?php if($inventory_item['pos_item'] === 'No') echo "checked"; ?>
                                        type="radio" value="<?=$inventory_item['pos_item'];?>" name="pos_item" id="No">
