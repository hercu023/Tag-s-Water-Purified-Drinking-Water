...
<div class="container">
    ...
    <?php  
                ...
                $total_records = $row[0];     
                $page_location = '../inventory/inventory-details.php';
                ...
                <table class="table" id="myTable">
                    ...
                    while ($rows = mysqli_fetch_assoc($result)) {?>
                        ...
                        <tr>
                            ...
                            <td data-label="POS"> <?php if($rows['pos_type'] == 'Yes'){
                                echo '<span class="instock"> YES </span>';
                                }else if($rows['pos_type'] == 'No'){
                                echo '<span class="lowstock"> NO </span>';
                                } ?></td>
                            <td data-label="Reorder Level"> <?php echo $rows['reorder_level']; ?></td>
                            <td data-label="SRP"> <?php echo '<span>&#8369;</span>'.' '.$rows['selling_price_item']; ?></td>
                            ...
                            <td>
                                <a href="../inventory/inventory-details-edit.php?edit=<?php echo $rows['id']; ?>" id="edit-action"class="edit-action" name="action">
            ...
            <form action="#">
                ...
                <span class="gender-title">POS ITEM</span>
                    <div class="gender-category" >
                        ...
                        <input type="radio" name="pos_item" id="No" value="2" onclick="mainForm2()">
