<?php
require_once '../service/archive-inventory.php';
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../CSS/inventory-details-archive.css">
            ...
            <div class="bg-editDropdown" id="edit-bgdrop">
                ...
                <div class="container1">
                    ...
                    <form action="#">
                        ...
                        <div class="a-header">
                            <label class="archive-header"> Do you want to Archive <?=$inventory_item['item_name'];?> item?</label>
                        </div>
                        <div class="bot-buttons">
                            ...
                            <div class="AddButton">
                                <button type="submit" id="addcustomerBtn" name="archive-inventory">ARCHIVE</button>
                            </div>
                        </div>
                </div>
            </div>
...
<script src="../javascript/inventory-details-archive.js"></script>
